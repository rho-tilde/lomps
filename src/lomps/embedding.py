...
def lift_left_canonical_seed(
    ...
    *,
    ...
    The default noise amplitude follows the production product-start setting:
    embed into the upper-left virtual block, add small deterministic noise in
    the new virtual subspace, and QR-project back to the canonical manifold.
    """
